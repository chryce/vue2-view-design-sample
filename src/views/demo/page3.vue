<template>
    <div class="i-layout-page-header">
        ...
        <Card dis-hover :bordered="false">
            ...
            <Button icon="ios-create-outline" style="margin-left: 8px" type="primary" ghost @click.native="editRecord">编辑</Button>
            ...
            <div style="margin: 10px;overflow: hidden">
                <div style="float: right;">
                    <Page :total="tableItem.total" :page-size='tableItem.pageSize' :current="tableItem.pageIndex" show-total show-sizer
